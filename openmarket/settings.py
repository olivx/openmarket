...
SECRET_KEY = config("SECRET_KEY", default="NOT_SO_MUCH_SECRET")
...
LOGGING = {
    ...
    "handlers": {
        ...
        "gunicorn-file-stream": {
            ...
            "filename": config("LOG_GUNICORN_FILE_STREAM", default="/var/log/app/gunicorn.log"),
            "maxBytes": 10_000_000,
            "backupCount": 3,
        },
        "app-file-stream": {
            ...
            "formatter": "console",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": config("LOG_APP_FILE_STREAM", default="/var/log/app/app.log"),
            "maxBytes": 10_000_000,
            "backupCount": 3,
        },
    },
    "loggers": {
        ...
        'api': {"handlers": ["stream", "app-file-stream"], "level": LOG_LEVEL},
        "openmarket": {"handlers": ["stream", "app-file-stream"], "level": LOG_LEVEL},
    },
}
